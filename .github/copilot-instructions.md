...
**First run auto-executes:** `npm install && composer install && npm run build`
...
**`bin/`** - Build scripts: archiveProject.js, updatePluginVersion.js, updateThemeVersion.js, lifecycleScripts/initialize.sh
