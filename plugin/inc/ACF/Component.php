...
class Component implements Component_Interface {
	...
	public function initialize() {
		if ( wp_get_environment_type() === 'development' && defined( 'LH_CURRENTLY_EDITING' ) && LH_CURRENTLY_EDITING === 'lhpbpp' ) {
	...
	public function add_options_page() {
		...
		$option_page = acf_add_options_page(
			array(
				...
				'icon_url'   => wp_lhpbpp()->get_admin_menu_icon( 'img/icons/slashes.svg' ),
