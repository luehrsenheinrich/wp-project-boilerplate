<?php
/**
 * LHPBPP\Plugin_Function_Interface interface
 *
 * @package lhpbpp
 */
...
interface Plugin_Function_Interface {
	/**
	 * Gets plugin function to expose as methods on the Plugin_Functions class instance, accessible through `wp_lhpbpp()`.
	 *
